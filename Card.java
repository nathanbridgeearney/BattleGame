...
public class Card {
    ...
    public static ArrayList<Card> getShuffledDeck(){
        ...
        for (String suitName : suitNames){
            deck.add(new Card(suitName, 1));
            deck.add(new Card(suitName, 2));
            deck.add(new Card(suitName, 3));
            deck.add(new Card(suitName, 4));
            deck.add(new Card(suitName, 5));
            deck.add(new Card(suitName, 6));
            deck.add(new Card(suitName, 7));
            deck.add(new Card(suitName, 8));
            deck.add(new Card(suitName, 9));
            deck.add(new Card(suitName, 10));
            deck.add(new Card(suitName, 11));
            deck.add(new Card(suitName, 12));
            deck.add(new Card(suitName, 13));
        }
